...
if (isset($_POST['submit'])) {
    ...
    if (!empty($name) && !empty($desc) && !empty($img)) {
        ...
        $str = "SELECT * FROM `stories` where `title`='" . $name . "'";
        $result = mysqli_query($con, $str);
        $number = mysqli_num_rows($result);
        if ($number > 0) {
            $_SESSION['failure']['message'] = "Stories already exists.";
        } else {
        ...
        <div class="col-md-12">
            <div class="password-panel">
                <div class="login-head">
                    <h1 class="text-center">Add Success Stories</h1>
                </div>
                <div class="login-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <span class="input-group-btn">
                            ...
                            <input type="text" class="form-control" placeholder="Recommended Image Size = 150px X 150px"
                                   readonly>
                        </div>
                        <br>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="desc" id="desc" rows="10" class="form-control1"
                        ...
                        <button class="btn btn-primary" type="submit" name="submit">Add Stories</button>
                    </form>
                </div>
            </div>
        </div>
