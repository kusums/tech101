...
if (isset($_POST['submit'])) {
    ...
    if (!empty($title) && !empty($description) && !empty($category) && !empty($img1) && !empty($status)
    ) {
        ...
        <div class="col-md-12">
            <div class="password-panel">
                <div class="login-head">
                    <h1 class="text-center">Add Works</h1>
                </div>
                <div class="login-body">
                    <form action="" method="post" enctype="multipart/form-data">

                        <div class="form-group">
                            <label for="title">Work Name <span style="color:red">*</span></label>
                            <input type="text" class="form-control" id="title" name="title" required>
                        </div>

                       <div class="form-group">
                            <label for="category">Category <span style="color:red">*</label>
                            <select class="form-control form-control2" name="category" id="category">
                                <option value="">Chooose Work Category</option>
                                <?php
                                $cat = "SELECT * FROM workcategory";
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="status">Work Status <span style="color:red">*</label>
                        ...
                        <button class="btn btn-primary" type="submit" name="submit">Add Packages</button>
                    </form>
                </div>
            </div>
        </div><!--grid 12 ends-->
